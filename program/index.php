...
<body style="margin-top: 30px; background-color: #0A2647;">
    <div class="container" style="background-color: #144272; width: 100%; padding: 10px;">
        <br><br>
        <div class="head">
        <h1 style="color: #FFFFFF;">Checklist Toilet</h1>
        <form>
            <div class="form-group" action="index.php" method="get" >
                <label for="q" style="color: #FFFFFF;">Search</label>
        ...
        <div class="main">
            ...
            <tr>
                ...
                <td style="color: #FFFFFF;">
                    <button class="btn" type="button" style="background-color: #54B435; width: 40%;"><a style="color: #FFFFFF;" href="ubah.php?id=<?= $row['id'];?>">EDIT</a></button> 
                    <button class="btn" type="button" style="background-color: #e4492e; width: 40%;"><a style="color: #FFFFFF;" href="hapus.php?id=<?= $row['id'];?>">DELETE</a></button>
                </td>
            </tr>
            <?php endwhile; else: ?>
            <tr>
        ...
        <div>
        <button class="btn" type="button" style="background-color: #2C74B3;"><a style="color: #FFFFFF" href="tambah.php">Tambah Data Checklist</a></button>
        </div> <br>
        <div>
        <button class="btn" type="button" style="background-color: #2C74B3;"><a style="color: #FFFFFF" href="home.php">Kembali</a></button>
        </div>
    </div>
</body>
</html>