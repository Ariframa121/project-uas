    ...
    <div class="container" class="container" style="background-color: #144272; width: 50%; padding: 30px;">
        ...
        <form>
            <div class="form-group" action="" method="get" >
                ...
                <button type="submit" name="submit" class="btn" style="background-color: #2C74B3;">Cari</button>
            </div>
        </form>
        </div>
        <div class="main">
            ...
            <tr>
                ...
                <td style="color: #FFFFFF;">
                    <button class="btn" type="button" style="background-color: #e4492e; width: 60%;"><a style="color: #FFFFFF;" href="hap_toilet.php?id=<?= $row['id'];?>">DELETE</a></button>
                </td>
            </tr>
            <?php endwhile; else: ?>
            <tr>
        ...
        <div>
        <button class="btn" type="button" style="background-color: #2C74B3;"><a style="color: #FFFFFF" href="tam_toilet.php">Tambah Data Toilet</a></button>
        </div> <br>
        <div>
